...
export const availableComponentsList = [
    ...
    { type: 'container', label: 'Container', defaultProps: { padding: '10px', backgroundColor: 'rgba(200,200,200,0.1)', minHeight: '80px', name: 'New Container', flexDirection: 'column' }, children: [] },
];
